...
class SPI_Data_Loader_Service():
    ...
    def write_to_xlsx_file(self, processed_data):
        self.view_service.printProgressBar(0, 100, prefix = 'Load-Data:', suffix = 'Complete', length = 50)
        ...
        for r, row in enumerate(processed_data):
            for c, value in enumerate(row):
                ...
                self.view_service.printProgressBar(progress, 100, prefix = 'Load-Data:', suffix = 'Complete', length = 50)
